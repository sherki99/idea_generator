...
# from agents.pain_point_discovery_agent import pain_point_discovery_node
# from agents.user_persona_analysis_agent import user_persona_analysis_node
...
def create_business_idea_workflow():
    ...
    # workflow.add_node("pain_point_discovery", pain_point_discovery_node)
    # workflow.add_node("user_persona_analysis", user_persona_analysis_node)
    ...
    workflow.add_edge("market_research", END )  # "pain_point_discovery"
